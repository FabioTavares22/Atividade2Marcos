...
const { buscarUsuarioPorLoginESenha } = require('../repositorios/usuarios')
...
const rotas_token = () => {
    ...
    router.post("/token", (req, res) => {
        try{
            ...
            if(usuario != buscarUsuarioPorLoginESenha.usuario){
                return res.status(401).send("Este usuário não tem permissão para modificação!")
            }
